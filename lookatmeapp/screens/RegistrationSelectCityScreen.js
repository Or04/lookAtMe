...
class RegistrationSelectCityScreen extends React.Component {
   ...
   async componentWillUnmount() {
    ...
    selectCityHandler = (renderItem) => {
        this.props.navigation.navigate({
            routeName: 'RegistrationSelectDigitalBoard', params: {
...
RegistrationSelectCityScreen.navigationOptions = (data) => {
    return {
...
export default RegistrationSelectCityScreen